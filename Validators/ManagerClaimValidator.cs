...
{
    public class ManagerClaimValidator : AbstractValidator<SubmitClaimVM>
    {
        private static readonly string[] AllowedExtensions = { ".pdf", ".docx", ".xlsx" };
        private const long MaxFileSize = 5 * 1024 * 1024; // 5MB

        public ManagerClaimValidator()
        {
            ...
            // 🔹 HoursWorked: Managers can claim up to 50 hours
            RuleFor(x => x.HoursWorked)
                .GreaterThan(0).WithMessage("HoursWorked must be greater than 0.")
                .LessThanOrEqualTo(50).WithMessage("HoursWorked cannot exceed 50.");
