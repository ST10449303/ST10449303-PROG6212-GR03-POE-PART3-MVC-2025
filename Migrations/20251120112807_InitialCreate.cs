        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerProfileId = table.Column<string>(type: "nvarchar(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_LecturerProfiles_LecturerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Claims_LecturerProfiles_LecturerProfileId",
                        column: x => x.LecturerProfileId,
                        principalTable: "LecturerProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LecturerProfileId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_LecturerProfileId",
                table: "Claims",
                column: "LecturerProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LecturerProfiles_EmployeeID",
